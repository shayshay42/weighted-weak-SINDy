...
cd "${PROJECT_ROOT}"
"${CPU_PYTHON}" -m lorenz63_benchmark.v2.prepare_context_matched \
  --config "${PROJECT_ROOT}/configs/v2/context_matched.json" \
  --output-dir "${PROJECT_ROOT}/queues/v2_context_matched" \
